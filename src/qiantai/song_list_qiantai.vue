    ...
    <div class="all">
        <div class="all-child1">
            <el-menu
                ...
                @select="handleSelect"
            >
                <el-menu-item index="1" @click="com('')" style="margin-left:20px">全部歌单</el-menu-item>
                <el-menu-item index="2" @click="com('华语')">华语</el-menu-item>
                <el-menu-item index="3" @click="com('粤语')">粤语</el-menu-item>
                <el-menu-item index="4" @click="com('欧美')">欧美</el-menu-item>
                <el-menu-item index="5" @click="com('日韩')">日韩</el-menu-item>
                <el-menu-item index="6" @click="com('轻音乐')">轻音乐</el-menu-item>
                <el-menu-item index="7" @click="com('BGM')">BGM</el-menu-item>
                <el-menu-item index="8" @click="com('乐器')">乐器</el-menu-item>
            </el-menu>
...
export default{
    ...
    methods:{
        com(a){
        this.$store.commit("getSong_listStyle",a)
        this.getSong_list()
      },
      getSong_list(){
            ...
            if(style === ''){
                ...
                this.$axios
                .get('/getSong_listPage?currentPage=' + this.currentPage + '&&pageSize=' + this.pageSize + '&&style=' + style)
                .then(successResponse => {
                this.songsList = successResponse.data.song_list
                this.total1=successResponse.data.total
                })
