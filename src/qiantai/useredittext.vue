...
<el-affix position="bottom" :offset="0">
    <div style="border-top: #a9a9a9 solid 1px;width:100%;height:60px;display: flex;background-color: rgb(255, 255, 255);">
        ...
        <button class="button1" style="margin-left:200px;" @click="addTextDraft()">保存</button>
        <button class="button1" @click="edittext()" style="margin-left:15px;background-color: rgb(255, 121, 25);color:#ffffff;">发布文章</button>
    </div>
</el-affix>
</div>
</template>
