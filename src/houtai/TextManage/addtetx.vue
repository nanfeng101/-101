...
<div style="margin-top:10px;">
    <v-md-editor :toolbar="toolbar" left-toolbar="undo redo clear | h bold italic strikethrough quote | ul ol table hr | link image code | tip emoji save" 
...
<el-dialog title="发布文章" v-model="dialog" width="600px">
  ...
  <div style="margin-top:20px;">
    ...
    <el-button type="primary" @click="addtext()">确认</el-button>
  </div>
</el-dialog>
...
export default{
    data(){
      return{
        ...
        //       action(editor) {
        //         const title =
        //           (editor.titles.length && `${editor.titles?.[0]?.title}.md`) || "下载.md";
    ...
    methods:{
      ...
      addtext(){
        ...
        this.addText.user_id=this.$store.state.userid
        this.$axios
